...
export interface CryptoSearchRef {
  focus: () => void;
}

const CryptoSearch = forwardRef<CryptoSearchRef, CryptoSearchProps>(
  function CryptoSearch(
    ...
    const handleKeyDown = (e: React.KeyboardEvent) => {
      ...
      switch (e.key) {
        ...
        case "Enter":
          ...
          if (
            highlightedIndex >= 0 &&
            highlightedIndex < cryptosToShow.length
          ) {
    ...
    return (
      <div id="crypto-search" ref={searchRef} className="relative w-full">
